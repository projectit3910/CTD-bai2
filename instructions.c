...
int emitSTS(CodeBlock* codeBlock) { return emitCode(codeBlock, OP_STS, DC_VALUE, DC_VALUE); }
...
int emitADS(CodeBlock* codeBlock) { return emitCode(codeBlock, OP_ADS, DC_VALUE, DC_VALUE); }
...
int emitDI(CodeBlock* codeBlock) { return emitCode(codeBlock, OP_DI, DC_VALUE, DC_VALUE); }
...
int emitCSW(CodeBlock* codeBlock) { return emitCode(codeBlock, OP_CSW, DC_VALUE, DC_VALUE); }
